...
var reportController = function(authService) {
  ...
  ctrl.owner = function(report){
    if (ctrl.user && (ctrl.user.id === ctrl.report.user.id)) {
      return true;
    }
    else return false;
  };
  ...
  template : `
      <div class="reportComponent well">
        ...
        <button class="btn btn-primary btn-lg" ng-show="$ctrl.owner($ctrl.report)"
	      ...
	      <button class="btn btn-primary btn-lg" ng-show="$ctrl.edit"
                ng-click="$ctrl.toggle()">Cancel</button>
        <div>
        	<report-form-component
              ng-show="$ctrl.edit && $ctrl.owner($ctrl.report)"
              edit="$ctrl.edit" report-info="$ctrl.report" >
            loading....
          </report-form-component>
        </div>
        ...
        <p ng-hide="$ctrl.reportQuiet">
          author: {{$ctrl.report.user.firstName}} {{$ctrl.report.user.lastName}}
        </p>
        <div class="">
